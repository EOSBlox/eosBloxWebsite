...
class AddPushManifest extends streams_1.AsyncTransformStream {
    ...
    generatePushManifest() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const allFragments = new Set((yield deps_index_1.buildDepsIndex(this.config.allFragments.map((path) => this.analyzer.resolveUrl(path_transformers_1.urlFromPath(this.config.root, path))), this.analyzer))
                .keys());
