...
function transformEsModuleToAmd(script, idx, jsOptions) {
    ...
    if (isExternal) {
        ...
        const newJs = js_transform_1.jsTransform(dom5.getTextContent(script), Object.assign({}, jsOptions, { transformModulesToAmd: true, moduleScriptIdx: idx }));
        dom5.setTextContent(script, newJs);
    }
}
