...
suite('capabilities', function () {
    ...
    test('safari mobile modules capability is predicated on iOS version', () => {
        assertBrowserCapabilities('Mozilla/5.0 (iPhone; CPU iPhone OS 11_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/11.0 Mobile/15E148 Safari/604.1', ['es2015', 'es2016', 'es2017', 'push']);
        assertBrowserCapabilities('Mozilla/5.0 (iPhone; CPU iPhone OS 11_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/11.0 Mobile/15E148 Safari/604.1', ['es2015', 'es2016', 'es2017', 'push', 'modules']);
    });
