...
~~`);
    ...
    suite('_parse()', () => {
        test('loads and parses an HTML document', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const doc = yield context['_parse'](analyzer.resolveUrl(`static/html-parse-target.html`), cancel_token_1.neverCancels);
        ...
        test('loads and parses a JavaScript document', () => __awaiter(this, void 0, void 0, function* () {
            const context = yield getContext(analyzer);
            const doc = yield context['_parse'](analyzer.resolveUrl(`static/js-elements.js`), cancel_token_1.neverCancels);
        ...
        test('returns a Promise that rejects for non-existant files', () => __awaiter(this, void 0, void 0, function* () {
            const context = yield getContext(analyzer);
            yield test_utils_1.invertPromise(context['_parse'](analyzer.resolveUrl(`static/not-found`), cancel_token_1.neverCancels));
        }));
    });
